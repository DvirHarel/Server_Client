...
ConnectionHandler::ConnectionHandler(string host, short port): host_(host), port_(port), io_service_(), socket_(io_service_),isConnect(false){
}
...
void ConnectionHandler::setHostPort(string host, short port)
{
    this->host_= host;
    this->port_= port;
}

void ConnectionHandler::setConnect()
{
    this->isConnect = true;
}
